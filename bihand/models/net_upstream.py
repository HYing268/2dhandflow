...
# from bihand.csflowmodel.model import get_cs_flow_model, save_model, FeatureExtractor, nf_forward
...
class NetUpstream(nn.Module):
    ...
    def forward(self, img, infos):
        ...
        # loss_fastflow, hm_out, mask_out = self.seednet(img,infos)
